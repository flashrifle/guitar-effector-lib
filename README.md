...
## 지금 들어있는 것 (104개 브랜드, 376항목)

| 타입 | 개수 | 비고 |
|---|---|---|
| `pedal` | 166 | 실제 노브를 확인한 것만 |
...
데이터는 Line 6 Helix, Neural DSP Quad Cortex, Fractal Audio 세 곳이 공개한 "based on" 목록을 기준으로 모았고, 여기에 실사용 요청이 잦은 리버브·딜레이를 더했어요. 노브 구성은 장비마다 공식 매뉴얼이나 제조사 페이지에서 확인해서 넣었고, **확인이 안 되는 건 넣지 않았어요** — 틀린 값을 "검증됨"으로 내보내는 것보다 없는 게 낫다고 봤어요.
